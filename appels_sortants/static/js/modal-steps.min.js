!function(a){
	...
	a.fn.modalSteps=function(b)
	 {var c=this,d=a.extend({btnCancelHtml:"Cancel",
	                         ...
	                         e=function(){
	                         	...
	                         	for(var b in d.callbacks)if(d.callbacks.hasOwnProperty(b)){var c=d.callbacks[b];if("*"!==b&&void 0!==c&&"function"!=typeof c)throw"Step "+b+" callback must be a function"}},
	                         		f=function(a){
